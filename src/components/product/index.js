        ...
        <div className='productThumb' onClick={setProductCat}>
...

            {
                ...
                <>
                    ...
                    <div className='info'>
                        <span className='d-block catName'>{productData.exercise_recommendation}</span>
                        ...
                        <span className='brand d-block text-g'>By <Link className='text-g'>{productData.exercise_recommendation}</Link></span>

                        <span className='brand d-block text-g'>By <Link className='text-g'>{productData.benefits}</Link></span>
