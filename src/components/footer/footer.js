            ...
            <section className='newsLetterSection'>
                <div className='container-fluid'>
                    <div className='box d-flex align-items-center'>
                        <div className='info'>
                            <h2>Delivering wellness, one natural remedy at a<br />time: Ayurveda, your trusted partner in health.</h2>
                            <p>Start You'r Shopping with Arogyam</p>
                    ...
                    <div className='container-fluid'>
                        <div className='row'>
                            <div className='col-md-3 part1'>
                                ...
                                <br /><br />
                                <p>Awesome medicine store website template</p>
                                <br />

                                <p><LocationOnOutlinedIcon /> <strong>Address</strong>: Kharghar, Navi Mumbai 410210, India</p>
                                <p><HeadphonesOutlinedIcon /> <strong>Call Us:</strong> (+91) - 540-025-124553 </p>
                                <p><EmailOutlinedIcon /> <strong>Email:</strong> sale@Arogyam.com</p>
                        ...
                        <div className='row lastStrip'>
                            <div className='col-md-3 part_1'>
                                <p>© 2024, Arogyam - HTML Ecommerce Template
